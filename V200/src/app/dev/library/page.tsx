...
const NOTEPAD: ThemeVars = {
  ...
  '--btn-secondary-bg':   '#f0efe9',
  '--btn-secondary-shadow':'none',
  '--btn-secondary-color':'#1e1e40',
  '--btn-secondary-bt':   '1.5px solid #1e1e40',
  '--btn-secondary-bl':   '4px solid #1e1e40',
  '--btn-secondary-br':   '1.5px solid #1e1e40',
  '--btn-secondary-bb':   '1.5px solid #1e1e40',

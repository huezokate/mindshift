...
// The dev log lives on the marketing host, so it wears the landing's pinned
...
export default function BlogIndexPage() {
  ...
  return (
    <div data-theme="notepad" className="notepad-paper min-h-dvh">
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px var(--page-pad) 64px' }}>
